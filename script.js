...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (faqModal) {
    const faqItems = [
      ...
      {
        question: 'What does a project with Baeroh involve?',
        answer: [
      ...
      {
        question: 'Do you handle the execution as well?',
        answer: [
      ...
      },
      {
        ...
        answer: [
          'In the Rajasthani dialect, baero means to know. Not knowing in the ordinary sense, but the quiet certainty in a voice that says: I know the way, do not worry, we are here now.',
