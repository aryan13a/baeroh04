...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const projects = {
    ...
    'canvas-ambition': {
      ...
      description: 'Great milestones are rarely achieved by chance; they are sculpted in the quiet hours of focused dedication. In this workplace, the clean lines of modern technology meet the grounding warmth of tailored, sophisticated tones. The commanding high-back chair stands ready for the visionary, while a golden bull sits quietly on the desk, a silent testament to strength, market conviction, and resilience. Wrapped in soft, ambient light that removes the harshness of the corporate world, this desk is more than a place to work, it is the launchpad where raw ambition is refined into legacy.',
      details: 'Great milestones are rarely achieved by chance; they are sculpted in the quiet hours of focused dedication. In this workplace, the clean lines of modern technology meet the grounding warmth of tailored, sophisticated tones. The commanding high-back chair stands ready for the visionary, while a golden bull sits quietly on the desk, a silent testament to strength, market conviction, and resilience.',
    ...
    'executive-studio': {
      ...
      description: 'An upscale corporate setting that masterfully balances privacy and collaborative space. Featuring a striking, floor to ceiling glass enclosed office complete with a plush swivel armchair, dark herringbone flooring, and an elegant curved partition wall. Outside, the open plan workplace flows naturally with warm toned desks, ergonomic chairs, and fluid, recessed ceiling lighting that guides the eye through a cohesive, high end professional environment.',
    ...
    'open-office': {
      ...
      detailsSecondary: 'Fluid LED strip lighting runs gracefully across the ceiling, accentuating the curves of the architectural walls. Hanging planters soften the structural boundaries, introducing nature to the workplace and fostering a fresh, productive atmosphere.',
      photography: 'Common Studio',
      styling: 'Stacy Tsai / Wool Studio',
    ...
    'elegant-workplace': {
      title: 'Elegant Workplace Design',
      subtitle: 'Workplace Design',
      location: 'Jaipur, Rajasthan',
      year: '2026',
      category: 'Interior · Workplace',
      image: 'assets/unnamed (1).webp',
      description: 'Every morning begins with quiet ambition. As sunlight slips through the curtains, the room awakens with warmth and purpose. The wooden desk patiently waits for the next idea, while the comfortable chairs invite conversations that could spark something extraordinary. Here, every detail plays its part in creating a workplace where productivity feels effortless and success finds its home.',
      details: 'Designed for productivity and quiet contemplation, the Elegant Workplace balances architectural structure with tactile comfort. A custom-crafted natural solid wood desk acts as the anchor of the room, surrounded by ergonomic, softly upholstered lounge chairs that invite relaxed but focused conversations.',
    ...
    'timeless-design-details': {
      ...
      subtitle: 'Reception & Commercial Design',
      location: 'Jaipur, Rajasthan',
      year: '2025',
      ...
      detailsSecondary: 'Delicate linen drapes diffuse natural sunlight during the day, while strategically placed warm lights illuminate natural stone and oak accents at dusk. This project showcases how minimal styling and high-quality craftsmanship create a reception environment that is both modern and welcoming.',
      photography: 'Common Studio',
      styling: 'Stacy Tsai / Wool Studio',
